...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cnBase(
        'pointer-events-none block h-[19.5px] w-[19.5px] rounded-full bg-base shadow-default ring-0 transition-transform ease-in-out radix-disabled:opacity-50 radix-state-checked:translate-x-5 radix-state-unchecked:translate-x-0 rtl:radix-state-checked:-translate-x-5'
      )}
    />
  </SwitchPrimitives.Root>
))
