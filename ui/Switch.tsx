...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cnBase(
        'pointer-events-none block h-4 w-4 rounded-full bg-base shadow-default ring-0 transition-transform ease-in-out radix-disabled:opacity-50 radix-state-checked:translate-x-4 radix-state-unchecked:translate-x-0 rtl:radix-state-checked:-translate-x-4'
      )}
    />
  </SwitchPrimitives.Root>
))
